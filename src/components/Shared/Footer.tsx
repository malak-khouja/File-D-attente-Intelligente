        ...
        <Row>
          <Col md={4} className="mb-4 mb-md-0">
            ...
            <div className="d-flex gap-3">
              <a href="https://www.facebook.com/malak.khouja/" className="text-white"><Facebook size={20} /></a>
              <a href="https://github.com/malak-khouja" className="text-white"><Twitter size={20} /></a>
              <a href="https://www.instagram.com/malak.khouja/" className="text-white"><Instagram size={20} /></a>
              <a href="https://www.linkedin.com/in/malak-khouja-4391762aa/" className="text-white"><Linkedin size={20} /></a>
            </div>
          </Col>
